import { getCurrentInstance, toRef, isRef, inject, defineAsyncComponent, version, defineComponent, h, Suspense, nextTick, Transition, computed, provide, reactive, ref, resolveComponent, shallowRef, useSSRContext, createApp, onErrorCaptured, unref } from 'vue';
