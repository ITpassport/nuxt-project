import { u as useRoute, e as appLayoutTransition, f as _wrapIf, b as useNuxtApp, g as useState, a as useHead, _ as _export_sfc, h as __nuxt_component_0$1 } from '../server.mjs';
import { defineComponent, h, inject, computed, unref, Transition, ref, onErrorCaptured, createElementBlock, defineAsyncComponent, toRefs, useSlots, useSSRContext, mergeProps, createElementVNode } from 'file:///workspaces/restrartnuixt3/node_modules/vue/index.mjs';
import { a as useAsyncData, j as jsonStringify, u as useCookie } from './ContentQuery.712d8093.mjs';
import { hash } from 'file:///workspaces/restrartnuixt3/node_modules/ohash/dist/index.mjs';
import { b as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.bccfc3d2.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate } from 'file:///workspaces/restrartnuixt3/node_modules/vue/server-renderer/index.mjs';
import { useRoute as useRoute$1 } from 'file:///workspaces/restrartnuixt3/node_modules/vue-router/dist/vue-router.node.mjs';
...
import 'file:///workspaces/restrartnuixt3/node_modules/destr/dist/index.mjs';
import 'file:///workspaces/restrartnuixt3/node_modules/unenv/runtime/fetch/index.mjs';
import 'file:///workspaces/restrartnuixt3/node_modules/scule/dist/index.mjs';
...
import 'file:///workspaces/restrartnuixt3/node_modules/html-tags/index.js';
import 'file:///workspaces/restrartnuixt3/node_modules/cookie-es/dist/index.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.f1f50357.mjs').then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import('./ContentDoc.3393ab14.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentList.1ee745d5.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => ContentNavigation).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentQuery.712d8093.mjs').then((n) => n.C).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRenderer.e0f9c1cc.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRendererMarkdown.ee52cf90.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentSlot.732f728e.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./Markdown.90787a27.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseA.5b5ef381.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseBlockquote.13facc84.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCode.229966f6.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCodeInline.997a73e1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseEm.e8d66440.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH1.17a0305b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH2.97f9a069.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH3.1f29d79b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH4.9b79efd0.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH5.4fe3350b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH6.c2c9fbeb.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseHr.ae3d2888.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseImg.4debdb73.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseLi.1c63d7a4.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseOl.f6b51afa.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseP.8784651c.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseStrong.5799a350.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTable.9bba0c68.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTbody.ff4f8415.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTd.eef8f121.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTh.cbb7c07d.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseThead.0a7f1159.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTr.2a3fef98.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseUl.bfdca394.mjs').then((c) => c.default || c));
...
//# sourceMappingURL=ContentNavigation.84b002c8.mjs.map
