...
import { defineComponent, h, inject, computed, unref, Transition, ref, onErrorCaptured, createElementBlock, defineAsyncComponent, toRefs, useSlots, useSSRContext, mergeProps, createElementVNode } from 'file:///workspaces/nuxt-project/node_modules/vue/index.mjs';
import { a as useAsyncData, j as jsonStringify, u as useCookie } from './ContentQuery.994e377b.mjs';
import { hash } from 'file:///workspaces/nuxt-project/node_modules/ohash/dist/index.mjs';
import { b as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.f0219b24.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate } from 'file:///workspaces/nuxt-project/node_modules/vue/server-renderer/index.mjs';
import { useRoute as useRoute$1 } from 'file:///workspaces/nuxt-project/node_modules/vue-router/dist/vue-router.node.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db.d9c7745c.mjs').then((m) => m.generateNavigation);
...
defineAsyncComponent(() => import('./ContentDoc.2adf0206.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentList.8a035ff9.mjs').then((c) => c.default || c));
defineAsyncComponent(() => Promise.resolve().then(() => ContentNavigation).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentQuery.994e377b.mjs').then((n) => n.C).then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRenderer.ca7e6a9f.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentRendererMarkdown.bb27e272.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ContentSlot.646f454d.mjs').then((c) => c.default || c));
...
defineAsyncComponent(() => import('./Markdown.e76eddea.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseA.42ebdc59.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseBlockquote.1440ad15.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCode.940cb6d6.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseCodeInline.9296b85c.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseEm.a106cb15.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH1.8b881b4b.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH2.e00b9b3d.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH3.784d5c49.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH4.b6a92c0e.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH5.d4026590.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseH6.e6db1df1.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseHr.7889b782.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseImg.4debdb73.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseLi.bbb4922e.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseOl.b9ab6b75.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseP.46201d92.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseStrong.9b7b03ff.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTable.159c62c5.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTbody.ff52c88e.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTd.74692da9.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTh.eedf60c8.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseThead.7f84cb10.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseTr.8782a986.mjs').then((c) => c.default || c));
defineAsyncComponent(() => import('./ProseUl.e47c6b8d.mjs').then((c) => c.default || c));
...
//# sourceMappingURL=ContentNavigation.acac7002.mjs.map
