import { ref, onServerPrefetch, defineComponent, toRefs, computed, useSlots, useSSRContext, unref, h } from 'file:///workspaces/restrartnuixt3/node_modules/vue/index.mjs';
...
import { hash, isEqual } from 'file:///workspaces/restrartnuixt3/node_modules/ohash/dist/index.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash } from 'file:///workspaces/restrartnuixt3/node_modules/ufo/dist/index.mjs';
import { parse, serialize } from 'file:///workspaces/restrartnuixt3/node_modules/cookie-es/dist/index.mjs';
import { appendHeader } from 'file:///workspaces/restrartnuixt3/node_modules/h3/dist/index.mjs';
import { u as useRequestEvent, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils.bccfc3d2.mjs';
...
const createQueryFetch = (path) => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db.f1f50357.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=ContentQuery.712d8093.mjs.map
