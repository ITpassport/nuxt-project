globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///workspaces/restrartnuixt3/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'http';
import { tmpdir } from 'os';
import { join as join$1 } from 'path';
import { mkdirSync } from 'fs';
import { parentPort, threadId } from 'worker_threads';
import { provider, isWindows } from 'file:///workspaces/restrartnuixt3/node_modules/std-env/dist/index.mjs';
...
import { createRenderer } from 'file:///workspaces/restrartnuixt3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///workspaces/restrartnuixt3/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///workspaces/restrartnuixt3/node_modules/vue/server-renderer/index.mjs';
...
import { preprocess } from 'file:///workspaces/restrartnuixt3/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///workspaces/restrartnuixt3/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///workspaces/restrartnuixt3/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///workspaces/restrartnuixt3/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///workspaces/restrartnuixt3/node_modules/micromark-util-chunked/dev/index.js';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"routeRules":{"/__nuxt_error":{"cache":false}},"envPrefix":"NUXT_"},"public":{"content":{"clientDB":{"isSPA":false},"navigation":{"fields":[]},"base":"_content","tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"highlight":false,"wsUrl":"ws://localhost:3002/","documentDriven":false,"anchorLinks":{"depth":4,"exclude":[1]}}},"content":{"cacheVersion":2,"cacheIntegrity":"kc4UzpZUjI","transformers":[],"base":"_content","watch":{"ws":{"port":4000,"hostname":"localhost","showURL":false}},"sources":{},"ignores":["\\.","-"],"locales":[],"highlight":false,"markdown":{"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"anchorLinks":{"depth":4,"exclude":[1]},"remarkPlugins":{},"rehypePlugins":{}},"yaml":{},"csv":{"delimeter":",","json":true},"navigation":{"fields":[]},"documentDriven":false,"experimental":{"clientDB":false}}};
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  if (!res) {
    const { template } = await import('file:///workspaces/restrartnuixt3/node_modules/@nuxt/ui-templates/dist/templates/error-dev.mjs') ;
    {
...
const _lazy_1j4n2z = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('/workspaces/restrartnuixt3/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('/workspaces/restrartnuixt3/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
