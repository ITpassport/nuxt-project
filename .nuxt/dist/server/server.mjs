...
import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, defineAsyncComponent, version, nextTick, shallowRef, provide, onErrorCaptured, unref, useSSRContext, Suspense, Transition, createApp } from "vue";
...
const components = {
  ContentDoc: defineAsyncComponent(() => import("./_nuxt/ContentDoc.2adf0206.js").then((c) => c.default || c)),
  ContentList: defineAsyncComponent(() => import("./_nuxt/ContentList.8a035ff9.js").then((c) => c.default || c)),
  ContentNavigation: defineAsyncComponent(() => import("./_nuxt/ContentNavigation.acac7002.js").then((c) => c.default || c)),
  ContentQuery: defineAsyncComponent(() => import("./_nuxt/ContentQuery.994e377b.js").then((n) => n.C).then((c) => c.default || c)),
  ContentRenderer: defineAsyncComponent(() => import("./_nuxt/ContentRenderer.ca7e6a9f.js").then((c) => c.default || c)),
  ContentRendererMarkdown: defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown.bb27e272.js").then((c) => c.default || c)),
  ContentSlot: defineAsyncComponent(() => import("./_nuxt/ContentSlot.646f454d.js").then((c) => c.default || c)),
  ...
  Markdown: defineAsyncComponent(() => import("./_nuxt/Markdown.e76eddea.js").then((c) => c.default || c)),
  ProseA: defineAsyncComponent(() => import("./_nuxt/ProseA.42ebdc59.js").then((c) => c.default || c)),
  ProseBlockquote: defineAsyncComponent(() => import("./_nuxt/ProseBlockquote.1440ad15.js").then((c) => c.default || c)),
  ProseCode: defineAsyncComponent(() => import("./_nuxt/ProseCode.940cb6d6.js").then((c) => c.default || c)),
  ProseCodeInline: defineAsyncComponent(() => import("./_nuxt/ProseCodeInline.9296b85c.js").then((c) => c.default || c)),
  ProseEm: defineAsyncComponent(() => import("./_nuxt/ProseEm.a106cb15.js").then((c) => c.default || c)),
  ProseH1: defineAsyncComponent(() => import("./_nuxt/ProseH1.8b881b4b.js").then((c) => c.default || c)),
  ProseH2: defineAsyncComponent(() => import("./_nuxt/ProseH2.e00b9b3d.js").then((c) => c.default || c)),
  ProseH3: defineAsyncComponent(() => import("./_nuxt/ProseH3.784d5c49.js").then((c) => c.default || c)),
  ProseH4: defineAsyncComponent(() => import("./_nuxt/ProseH4.b6a92c0e.js").then((c) => c.default || c)),
  ProseH5: defineAsyncComponent(() => import("./_nuxt/ProseH5.d4026590.js").then((c) => c.default || c)),
  ProseH6: defineAsyncComponent(() => import("./_nuxt/ProseH6.e6db1df1.js").then((c) => c.default || c)),
  ProseHr: defineAsyncComponent(() => import("./_nuxt/ProseHr.7889b782.js").then((c) => c.default || c)),
  ProseImg: defineAsyncComponent(() => import("./_nuxt/ProseImg.4debdb73.js").then((c) => c.default || c)),
  ProseLi: defineAsyncComponent(() => import("./_nuxt/ProseLi.bbb4922e.js").then((c) => c.default || c)),
  ProseOl: defineAsyncComponent(() => import("./_nuxt/ProseOl.b9ab6b75.js").then((c) => c.default || c)),
  ProseP: defineAsyncComponent(() => import("./_nuxt/ProseP.46201d92.js").then((c) => c.default || c)),
  ProseStrong: defineAsyncComponent(() => import("./_nuxt/ProseStrong.9b7b03ff.js").then((c) => c.default || c)),
  ProseTable: defineAsyncComponent(() => import("./_nuxt/ProseTable.159c62c5.js").then((c) => c.default || c)),
  ProseTbody: defineAsyncComponent(() => import("./_nuxt/ProseTbody.ff52c88e.js").then((c) => c.default || c)),
  ProseTd: defineAsyncComponent(() => import("./_nuxt/ProseTd.74692da9.js").then((c) => c.default || c)),
  ProseTh: defineAsyncComponent(() => import("./_nuxt/ProseTh.eedf60c8.js").then((c) => c.default || c)),
  ProseThead: defineAsyncComponent(() => import("./_nuxt/ProseThead.7f84cb10.js").then((c) => c.default || c)),
  ProseTr: defineAsyncComponent(() => import("./_nuxt/ProseTr.8782a986.js").then((c) => c.default || c)),
  ProseUl: defineAsyncComponent(() => import("./_nuxt/ProseUl.e47c6b8d.js").then((c) => c.default || c))
};
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/_...slug_.aa772597.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/batikansikoku.1a76bc11.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/free-megami.2f332f4a.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/game.69a6ee4d.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/grid.ec760197.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.2763ceb2.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/kerun-daiseido.8279c014.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/recipe.205d0ef9.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/ta-zimaharu.d466a39d.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.71fffb60.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
