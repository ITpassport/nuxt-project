import { ref, onServerPrefetch, unref, defineComponent, toRefs, computed, useSlots, useSSRContext, h } from "vue";
...
import { u as useRequestEvent, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from "./utils.f0219b24.js";
...
const createQueryFetch = (path) => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db.d9c7745c.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=ContentQuery.994e377b.js.map
