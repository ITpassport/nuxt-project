<template>
    ...
    <h2>ケルン大聖堂の背景</h2>
    <img src="kerun-daiseido.vue" class="img-fluid" alt="kerun-daiseido">
    <p class="fs-3">1880年に完成した大聖堂はフランス式ゴシック様式のカトリック教会で、約632年の歳月をかけて建てられました。1164年にミラノから送られた東方三博士の聖遺骨を納めるのにふさわしい聖堂を建築したいと建てられ、ゴシック様式の建築物の中では世界最大級といわれています。ドームの高さはそんなには高くありませんが、大きく突き出た2本の塔には圧倒されます。
